...
"""
i    # Vẽ đồ thị hội tụ trung bình
    plt.figure(figsize=(10, 6))
    colors = {'TSILS': 'purple', 'GWO': 'blue', 'WDGWO': 'red', 'CGWO': 'green'}
    linestyles = {'TSILS': '-', 'GWO': '-', 'WDGWO': '-', 'CGWO': '--'}t numpy as np
...
def run_experiments(n_trials=10, n_wolves=30, max_iter=200):
    ...
    algorithms = {
        'TSILS': TSILS_JCAS,  # Baseline method
        'GWO': GWO_JCAS,
    ...
    plt.figure(figsize=(10, 6))
    colors = {'GWO': 'blue', 'WDGWO': 'red', 'CGWO': 'green'}
    linestyles = {'GWO': '-', 'WDGWO': '-', 'CGWO': '--'}
...
if __name__ == "__main__":
    ...
    print("  - beam_patterns.png         : Các beam pattern tốt nhất")
    print("  - improvements.txt          : Phần trăm cải thiện")
    print("=" * 70)
